...
function Nav_bar(props) {
  ...
  return (
    <div className={s.nav_bar}>
      ...
      <div className={s.item}><Link to={"/profile/" + props.authorizedId} className={navData => navData.isActive ? s.activeLink : s.notActiveLink} >Profile</Link></div>    {/* this is the way I create the links here, and they automatically link to the links  */}
