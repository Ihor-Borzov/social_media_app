...
<div className="body_wrapper">
  ...
  <Route path="/profile" element={<Profile state={props.state.myPostsPage}  posts={props.posts} updateNewPostText={props.updateNewPostText} />}/>   {/*  for the clickable link check Nav_bar.jsx */}
